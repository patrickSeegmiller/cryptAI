...
You will also find my own implementations of common functions for computations like the greatest common divisor of to natural numbers, integer square roots, etc. These are solely for fun or education and you should probably just rely on the optimized versions available in standard libraries.
