...
from whole_number_tools import find_modular_inverse, greatest_common_divisor

class Cipher():
    """
    A generic Cipher object.
    """
...
class KeyedCaeserCipher(Cipher):
    def __init__(self) -> None:
        """
...
class KeyedColumnarTranspositionCipher(Cipher):
    def __init__(self) -> None:
        """
...
class DoubleColumnarTransposition(Cipher):
    def __init__(self) -> None:
        pass
